...
__global__ void init_deltaKx(float* deltaKx, const int* m0, const float x0, const float* ky, const float* ftwist); //JMH
...
__global__ void init_kperp2_ntft(float* kperp2, const float* kx, const float* ky, 
				 ...
				 const float* ftwist, const float* bmagInv, float shat, const float* deltaKx); //JMH
