...
enum class Tmethod {sspx2, sspx3, rk3, rk4, k10, g3, k2, ssprk3, imex3, imex4, imex_full, strang, lie_trotter, lie_trotter_elec, lie_trotter_green, imex_green}; 
...
class Parameters {
 ...
 public:
  ...
  int nx_in, ny_in, jtwist, nm_in, nl_in, nstep, nstep_restart, nspec_in, nspec, implicit_max_iter, implicit_max_iter_streaming;
  ...
  float fphi, fapar, fbpar, kpar_init, shaping_ps, implicit_omega, implicit_omega_streaming, implicit_linked;
  ...
  bool init_electrons_only, drift_kinetic_electrons;
  ...
  std::string closure_model, boundary, source, implicit_preconditioner;
