...
####################################
OBJS = device_funcs.o parameters.o grids.o reductions.o grad_perp.o fields.o moments.o forcing.o grad_parallel.o grad_parallel_linked.o geometry.o laguerre_transform.o nca.o ncdf.o solver.o smith_par_closure.o closures.o linear.o nonlinear.o ts_sspx2.o ts_sspx3.o ts_rk3.o ts_rk4.o ts_k10.o ts_imex.o ts_imex_full.o ts_lie_trotter.o ts_strang.o ts_ssprk3.o ts_lie_trotter_green.o ts_imex_green.o diagnostics.o run_gx.o version.o trinity_interface.o diagnostic_classes.o spectra_calc.o cublas_test.o cusolve.o green.o grad_parallel_NTFT.o exb.o mirror_magma.o
